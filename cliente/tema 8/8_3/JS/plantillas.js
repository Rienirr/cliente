...
div.innerHTML =` <span class="colum">${nombre}</span>  <span class="colum">${peso} Kg </span> <span class="colum">${precio} €</span> <span class="colum">${descripcion} </span> <span class="colum img"> <img  class="colum" src=${imagen} alt="no se ha podido cargar la imagen" width="100" height="100"> </span><div> <button  class="anyadirALaLista" > Añadir a la lista</button><img  class="EditarProducto" src="./imagenes/editar.png" alt="Editar producto" width="15" height="15"> </div>`;
return div;
}
...
export function formularioParaEditarLista(nombreLista,nombresProductos){
    ...
    form.innerHTML+="<input type='button' value='Editar' id='EditarLista'></input>"
    return form;
    }
